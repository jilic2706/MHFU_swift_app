...
struct MonsterRowView: View {
    ...
    var body: some View {
        NavigationLink(
            destination: MonsterDetailView(bookmarksViewModel: bookmarksViewModel, monster: monster, allLocations: allLocations)) {
            VStack(spacing: 0) {
                Spacer()
                ZStack {
                    HStack(spacing: 14) {
